...
/* in file lifibclear.c */
extern	void	lifibclear(struct lifiblk *, int32);

/* in file lifibget.c */
extern	void	lifibget(did32, ibid32, struct lifiblk *);

/* in file lifibput.c */
extern	status	lifibput(did32, ibid32, struct lifiblk *);

/* in file lifdbfree.c */
extern	status	lifdbfree(did32, dbid32);

/* in file lifdballoc.c */
extern	dbid32	lifdballoc(struct lifdbfree *);

/* in file lifindballoc.c */
extern	dbid32	lifindballoc(struct lifdbfree *);

/* in file lifindballoc.c */
extern void	lifindbinit (dbid32 *indbuf);

/* in file lifflush.c */
extern	status	lifflush(struct liflcblk *);

/* in file lifiballoc.c */
extern	ibid32	lifiballoc(void);

/* in file liflclose.c */
extern	devcall	liflclose(struct dentry *);

/* in file liflcontrol.c */
extern	devcall	liflcontrol(struct dentry *, int32, int32, int32);

/* in file liflgetc.c */
extern	devcall	liflgetc(struct dentry *);

/* in file liflinit.c */
extern	devcall	liflinit(struct dentry *);

/* in file liflputc.c */
extern	devcall	liflputc(struct dentry *, char);

/* in file liflread.c */
extern	devcall	liflread(struct dentry *, char *, int32);

/* in file liflseek.c */
extern	devcall	liflseek(struct dentry *, uint32);

/* in file liflwrite.c */
extern	devcall	liflwrite(struct dentry *, char *, int32);

/* in file lifscheck.c */
extern	status	lifscheck(struct lifdir *);

/* in file lifscreate.c */
extern  status  lifscreate(did32, ibid32, uint32);

/* in file lifsinit.c */
extern	devcall	lifsinit(struct dentry *);

/* in file lifsopen.c */
extern	devcall	lifsopen(struct dentry *, char *, char *);

/* in file lifsetup.c */
extern	status	lifsetup(struct liflcblk *);

/* in file liftruncate.c */
extern	status	liftruncate(struct liflcblk *);
