...
#define LIFILESYS           24	/* type lifs     */
#define LIFILE0             25	/* type lifl     */
#define LIFILE1             26	/* type lifl     */
#define LIFILE2             27	/* type lifl     */
#define LIFILE3             28	/* type lifl     */
#define LIFILE4             29	/* type lifl     */
#define LIFILE5             30	/* type lifl     */
