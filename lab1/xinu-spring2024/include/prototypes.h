...
/* in file createvariant.c */
extern	pid32 createvariant(void *funcaddr, uint32 ssize, pri16 priority, char *name, uint32 nargs, ...);
/* in file greetings.c */
extern	void greetings(void);
/* in file getparentprstate.c */
extern int	getparentprstate(pid32);
/* in returnwrapper.c */
extern void returnwrapper(void);
/* in file createvariant2.c */
extern	pid32 createvariant2(void *funcaddr, uint32 ssize, pri16 priority, char *name, uint32 nargs, ...);
